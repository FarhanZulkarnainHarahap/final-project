...
import { getInventoryData, updateStockWithJournal, createStockEntry, deleteStockEntry, getInventoryHistory, getLowStockAlerts, } from "../controllers/inventory-controller.js";
...
router
    ...
    .post(verifyToken, roleGuard("SUPER_ADMIN", "STORE_ADMIN"), updateStockWithJournal);
...
router
    .route("/history")
    .get(verifyToken, roleGuard("SUPER_ADMIN", "STORE_ADMIN"), getInventoryHistory);
