...
import { getAllProduct, getAllProductsByCity, getNearbyProducts, getProductById, } from "../controllers/product-controller/get/get-product.js";
...
import { deleteProduct, updateProduct, } from "../controllers/update-product-controller.js";
import { getAllProductsByStore } from "../controllers/get-product-controller.js";
const router = express.Router();
router
    .route("/")
    .get(getAllProduct)
    .post(verifyToken, roleGuard("SUPER_ADMIN", "STORE_ADMIN"), upload.fields([
...
router
    .route("/:id")
    .get(getProductById)
    .patch(verifyToken, roleGuard("SUPER_ADMIN", "STORE_ADMIN"), upload.fields([
    { name: "imagePreview", maxCount: 1 },
    { name: "imageContent", maxCount: 3 },
]), updateProduct)
