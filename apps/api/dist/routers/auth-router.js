...
import { loginFailed, loginGoogle, loginSuccess, } from "../controllers/auth-controller/login/login-google.js";
import { logout } from "../controllers/auth-controller/logout/logout.js";
import { confirmEmail, sendVerificationEmail, VerifySuccess, } from "../controllers/auth-controller/verification/verification.js";
import { login } from "../controllers/auth-controller/login/login-market-snap.js";
import { resendSetPasswordLink, resetPassword, } from "../controllers/auth-controller/set-password/set-password.js";
