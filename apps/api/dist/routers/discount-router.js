...
import { getDiscounts, createDiscount, updateDiscount, deleteDiscount, getDiscountUsageReport, } from "../controllers/discount-controller.js";
...
router
    .route("/usage-report")
    .get(verifyToken, roleGuard("SUPER_ADMIN", "STORE_ADMIN"), getDiscountUsageReport);
router
    .route("/:id")
