...
export async function register(req, res) {
    try {
        ...
        const templateSource = await fs.readFile("src/templates/registration-welcoming-template.hbs", "utf-8");
        ...
        res.status(201).json({
            message: "Akun berhasil dibuat. Silakan cek email untuk membuat password.",
        });
    }
    catch (error) {
