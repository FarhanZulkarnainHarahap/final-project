...
export async function createStoreAdmin(req, res) {
    try {
        ...
        const { firstName, lastName, email, username, password, phoneNumber, storeId, // ID toko yang akan dikelola oleh store admin ini
         } = req.body;
        // Validasi input
...
/* -------------------------------------------------------------------------- */
export async function updateStoreAdmin(req, res) {
    try {
        // Cek apakah user yang request adalah SUPER_ADMIN
        const user = req.user;
        const userRole = user.role;
        ...
        const { id } = req.params;
        const { firstName, lastName, email, username, phoneNumber, storeId } = req.body;
...
/* -------------------------------------------------------------------------- */
export async function getStoreAdmins(req, res) {
    try {
        // Cek apakah user yang request adalah SUPER_ADMIN
        const user = req.user;
        const userRole = user.role;
...
/* -------------------------------------------------------------------------- */
export async function getStoreAdminById(req, res) {
    try {
        // Cek apakah user yang request adalah SUPER_ADMIN
        const user = req.user;
        const userRole = user.role;
